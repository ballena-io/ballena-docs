...
El token BALLE está listado en BSCScan y se puede comprar y vender en [PancakeSwap](https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x9f0d5f45ce8573f43e0ba17876329784be0fd700).
...
Sí, puedes encontrar las auditorías [aquí](https://github.com/ballena-io/ballena-audits).



#### 2. ¿Se han verificado sus contratos?

Sí. El código de todos los contratos ha sido **verificado y publicado en** **BSCScan**. Para más información haz clic [aquí](../tecnico/tokenomics.md).

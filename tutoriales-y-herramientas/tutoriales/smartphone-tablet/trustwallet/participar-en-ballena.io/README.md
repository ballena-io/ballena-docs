...
Mediante los pasos detallados en este apartado, invertiremos nuestro dinero en una BalleVault en [ballena.io](https://app.ballena.io/)🐋. La plataforma nos dará altos retornos sobre los activos invertidos y, además, **nos recompensará con tokens BALLEv2.**



### 2. Proveer liquidez de **los** token BALLEv2 en la Staking Pool.

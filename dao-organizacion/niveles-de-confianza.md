...
Es una _etapa perfecta para la adquisición de información_ y visitar todos los canales del proyecto. El TL0 puede familiarizarse con las bases del proyecto, la organización y las distintas áreas de la misma, y a su vez, ver si es capaz de aportar contenido de calidad al mismo.
...
Se reconoce como miembro activo.
...
La transferencia del nivel de un usuario TL0 a TL1 se origina, principalmente, debido a la actividad y aportaciones del mismo en los canales del Discord de ballena.io.  
...
El cambio de nivel de un usuario de TL2 a TL3 será propuesto por uno de los líderes TL3 del proyecto y sometido a votación en la plataforma vote.ballena.io.  

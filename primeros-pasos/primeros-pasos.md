...
* Por otro lado, [ballena.io](https://ballena.io/) trabaja sobre los fondos de [PancakeSwap](https://pancakeswap.finance/), una de las mejores plataformas DeFi hasta el momento. Estos se encuentran en las BalleVaults de nuestra plataforma, más información en [BalleVaults](../tecnico/productos/ballevaults-de-pancake-swap.md). Puedes ver todo su código y [auditorias de seguridad](https://certik-public-assets.s3.amazonaws.com/REP-PancakeSwap-16_10_2020.pdf) en la documentación de su plataforma.
